...
def export_pdf_report():
    ...
    # Custom Notes for DeepSeek Integration
    pdf.cell(200, 10, txt="Custom Notes for DeepSeek Integration:", ln=True, align="L")
    ...
    pdf.cell(200, 10, txt="Specific Fields or Tags for DeepSeek Analysis:", ln=True, align="L")
